...
code <- nimbleCode(
  {
    ...
    for (xx in 2:2) { p11.b[xx] ~ dnorm(0, sd=100) }
    for (t in 1:(nyear-1)){ 
...
inits <- function()list ( 
  ...
  mean.b=runif(1),
  b.b=c(runif(4, -0.1, 0.1)),
  p10.b=c(runif(3, -0.1, 0.1)),
  p11.b=runif(2, -0.1, 0.1),
  mean.gamma= runif(1),
  mean.phi=runif(1),
...
n.chains=3; n.thin=100; n.iter=400000; n.burnin=300000
